  ...
  return (
    <section className="main-slider">
      <Swiper {...mainSlideOptions}>
        {SliderOneData.map(({ image, subTitle, button }, index) => (
            ...
            <Container>
              <Row>
                <Col lg={12} className="text-center">
                  <p className="main-slider__subtext">{body.en}</p>
                  <h3 className="main-slider__title">{title.en}</h3>
