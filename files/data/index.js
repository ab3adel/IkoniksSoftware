...
export const SliderOneData = [
  {
    image: sliderOne01,
    subTitle: "WELCOME TO IKONIKS SOFTWARE",
    title: "SMART WEB \n DESIGN AGENCY.",
    button: {
      label: "DISCOVER MORE",
      url: "/about"
...
export const ServiceHomeTwoData = {
  subTitle: "welcome to IKONIKS SOFTWARE web agency",
...
export const AboutOneData = {
  sectionContent: {
    title: "build better website alot quicker with IKONIKS SOFTWARE",
...
export const AboutTwoData = {
  sectionContent: {
    ...
    subTitle: "welcom to IKONIKS SOFTWARE",
    text:
